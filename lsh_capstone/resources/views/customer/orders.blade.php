                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pt_10 pb_10">
                                            ...
                                            <a href="{{ route('customer_review_add', $row->id) }}" class="btn btn-primary mb-md-0 mb-1" data-toggle="tooltip" data-placement="top" title="Rate Now"><i class="fa fa-star-half-o" aria-hidden="true"></i></a>
                                        </td>
